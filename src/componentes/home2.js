    ...
    return (
        ...
        <div>
                ...
                <div class="align-items-stretch flex-main-1">
                    <div className='f-hover-e'>
                        <a href='#' className='content-a'>
                            ...
                            <p className='img-p'><b>Art & Graphics</b></p>
                        </a>
                    </div>
                    <div className='f-hover-e'>
                        <a href='#' className='content-a'>
                            ...
                            <p className='img-p'><b>Digital & TV</b></p>
                        </a>
                    </div>
                    <div className='f-hover-e'>
                        <a href='#' className='content-a'>
                            ...
                            <p className='img-p'><b>Blog & Writing</b></p>
                        </a>
                    </div>
                    <div className='f-hover-e'>
                        <a href='#' className='content-a'>
                            ...
                            <p className='img-p'><b>Video & Youtube</b></p>
                        </a>
                    </div>
                    <div className='f-hover-e'>
                        <a href='#' className='content-a'>
                            ...
                            <p className='img-p'><b>Podcast</b></p>
                        </a>
                    </div>
                </div>
                <div class="align-items-stretch flex-main-1">
                    <div className='f-hover-e'>
                        <a href='#' className='content-a'>
                            ...
                            <p className='img-p'><b>Technology</b></p>
                        </a>
                    </div>
                    <div className='f-hover-e'>
                        <a href='#' className='content-a'>
                            ...
                            <p className='img-p'><b>Business</b></p>
                        </a>
                    </div>
                    <div className='f-hover-e'>
                        <a href='#' className='content-a'>
                            ...
                            <p className='img-p'><b>Lifestyle</b></p>
                        </a>
                    </div>
                    <div className='f-hover-e'>
                        <a href='#' className='content-a'>
                            ...
                            <p className='img-p'><b>Big Data</b></p>
                        </a>
                    </div>
            ...
            <div className='simpld'>
                <p className='simplh'><b>Get inspired by projects made on TAC</b></p>
                </div>
        </div>
    )
}
