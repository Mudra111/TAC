...
import SocialMarketCar from "./SocialMarket-Carousel";
import Insta from "./Insta";
import "./SCM.css";
import SCMSubNav from "./SCM-SubNav";
import SCMSortingComp from "./SCM-SortingComp";

function SocialMarketing() {
  return (
    <div>
      <div className="SCM-mainhead">
        <h1 className="SCM-heading">Social Media Marketing</h1>
        <div className="SCM-subhead">
          <p>
          ...
          <div>
            ...
            <a href="#">Learn more about Social Media Marketing</a>
          </div>
        </div>
      </div>
      ...
      <div className="sticky-SCMSubNav">
        <SCMSubNav />
      </div>
      <div>
        <SCMSortingComp />
