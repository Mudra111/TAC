...
export default function Messages1({ MsgBoxClose }) {
  const [disNoti, setDisNoti] = useState(true);
  const [disInbox, setDisInbox] = useState(false);
        ...
        <div className="msgs-display">
          {disNoti && (
            <div className="msg-empty">
              ...
              <p className="content">
                Browse our amazing catalog of Gigs or offer your talent on TAC.
              </p>
            </div>
          )}
          {disInbox && (
